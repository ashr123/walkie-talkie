...
| `--channel <name>`           | **required**             | Channel to join — **1–64 letters or digits in any language** (Hebrew, Han, Greek), plus `_` and `-`; no whitespace or dots. Required for every mode except global, which always uses the reserved `global` room.                                                                                                                                                                                                                                                                            |
