...
| `--gui`                      | off                      | Open a **window** instead of the terminal prompt. The window adds **hold-to-talk** — press and hold the Talk button — which a console cannot offer, since a keystroke has no press/release edges. Same client underneath: identical audio, encryption and floor rules.                                                                                                                                                                                                                      |
