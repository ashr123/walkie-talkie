 ...
 *
 * <p>Jackson 3 needs only {@link JsonTypeInfo} on a sealed type; the permitted subtypes are
 * discovered automatically, and each carries a stable wire name via {@link JsonTypeName}.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type")
public sealed interface ClientMessage {

	/**
	 * Join (or create) a channel. For {@link ChannelMode#GLOBAL_PTT} the channel name is _.
	 */
	@JsonTypeName("join")
